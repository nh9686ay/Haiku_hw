...
1. Change into the new directory and create a development branch to work on. (This step can be optional, listen to your section lead here on options) 
1. Fulfill the listed requirements.

When you have fulfilled the requirements below, make a pull request on this
repository to turn in your work.

Ideally this homework can be turned in, or work started on it tomorrow, but you to Tuesday Feb 2/8 6pm ET to submit it.
...
1. Now perform the github **pull request workflow** to "submit" these changes to our classrooms 
2. If you did it correctly, you should be able to see your [submission here.](https://git.generalassemb.ly/staging-125/haiku/edit/master/README.md)
